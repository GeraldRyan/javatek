...
//		app.connect();
		...
		int id;
		/*
		 * 1. Add an employee to the database 2. Access an employee info from the
		...
		while (choice != 8) {
			...
			case 1:
				...
				Employee emp = new Employee(Integer.parseInt(sc.nextLine()), sc.nextLine(),
